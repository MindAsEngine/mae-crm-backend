...
#                                               "status": ads_integrations.send_to_facebook_platform(audience_name, applications),
#                                               "timestamp": datetime.datetime.now().isoformat()})
#             if cabinet == "google":
#                 integrations_statuses.append({"cabinet": "google",
#                                               "status": ads_integrations.send_to_google_platform(audience_name, applications),
#                                               "timestamp": datetime.datetime.now().isoformat()})
